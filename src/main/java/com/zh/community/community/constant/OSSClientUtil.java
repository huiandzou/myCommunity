...
public class OSSClientUtil {
    ...
    private String uploadFile2OSS(InputStream instream, String fileName) {
        ...
        try {
            ...
            PutObjectResult putResult = build.putObject(bucketName, filedir + fileName, instream, objectMetadata);
    ...
    public String getUrl(String key) {
        ...
        // 生成URL
        OSS build = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
        URL url = build.generatePresignedUrl(bucketName, key, expiration);
        if (url != null) {
            return url.toString();
        }
        return null;
